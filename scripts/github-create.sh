...
echo "Will create a new *$PRIVACYWORD* repo named mariadb"
echo "on github.com in:"
echo "    user account: admindaspanel"
echo "    organization: daspanel"
echo "with this description:"
echo MariaDB running inside Docker container using Alpine Linux with S6 Overlay init system.
echo ""
...
curl -u admindaspanel https://api.github.com/orgs/daspanel/repos -d \
    "{\"name\": \"mariadb\", \"description\": \"MariaDB running inside Docker container using Alpine Linux with S6 Overlay init system.\", \"private\": $PRIVATE_TF}"
